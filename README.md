...
- `endpoint` is an optional field to specify a DNS name of IP that will override what is obtained from traversing network interfaces. This can be useful in special cases such as during testing or when using bridged networking.
